...
# Reuse YOLOv5 postprocess/draw/letterbox helper from existing demo
from yolov5 import COCO_test_helper, IMG_SIZE, post_process, draw, OBJ_THRESH, NMS_THRESH

# Paths (relative to this script)
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
ONNX_MODEL = os.path.join(SCRIPT_DIR, '..', 'model', 'yolov5n.onnx')
IMG_PATH = os.path.join(SCRIPT_DIR, '..', 'model', 'bus.jpg')
RKNN_MODEL = os.path.join(SCRIPT_DIR, '..', 'model', 'yolov5_sim.rknn')
OUT_DIR = os.path.join(SCRIPT_DIR, 'result_sim_v5')
...
def main():
    ...
    parser.add_argument('--anchors', type=str, default='../model/anchors_yolov5.txt', help='anchor file for YOLOv5')
    ...
    print(f'Using anchors from {args.anchors}: {anchors}')
    ...
    # Keep consistent with yolov5.py
